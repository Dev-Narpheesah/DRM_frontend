...
const About = () => {
  ...
  return (
    <section
      className={`${styles.aboutSection} ${isDarkMode ? styles.dark : ""}`}
    >
          ...
          <Block
            ...
            text={
              <ul className={styles.values}>
                ...
                <li>
                  <strong>Collaboration:</strong> Uniting efforts for effective
                  relief.
                </li>
                
                <li>
                  <strong>Resilience:</strong> Empowering communities to
                  rebuild.
                </li>
              </ul>
            }
